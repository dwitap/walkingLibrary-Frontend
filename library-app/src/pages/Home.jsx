            ...
            <Box flex="1" bg="" width="760px" h="300px" paddingTop="30px">
              ...
              >
                ...
                <Box
                    ...
                    paddingTop={"-100px"}
                >
                    Selamat datang di perpustakaan resep makanan Krusty Krab{" "}
                    <br />
                    Lebih dari 9 miliar resep masakan dapat ditemukan disini!{" "}
                    <br />
                    <br />
                    ...
                    <Flex color="black">
                        <Box w="505px" bg="white" fontSize="3xl">
                            <Text textAlign="center" paddingTop="150px">
                                Temukan Resep Favoritmu dan buat keluargamu
                                nyaman dirumah.
                            </Text>
                        </Box>
                        ...
                        >
                            ...
                            >
                                <Text
                                    ...
                                    fontFamily={"sans-serif"}
                                >
                                    Jl. Raya Bikini Bottom No. 2, Kec. Simpang
                                    kerang, Samudera Pasific
                                </Text>
                            </Square>
                            <Square
                                justifyContent={"center"}
