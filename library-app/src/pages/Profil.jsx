...
const Profil = () => {
  return (
    <Box marginLeft={"40px"} marginRight="40px">
      <Text fontSize={"5xl"} fontFamily="heading" textAlign="center" marginTop={"50px"}>
        VISI
      </Text>
      <Text fontSize={"2xl"} fontFamily="body" marginTop={"20px"}>
        {" "}
      ...
      <UnorderedList fontFamily={"body"} fontSize="2xl" marginTop={"20px"}>
        <ListItem>
